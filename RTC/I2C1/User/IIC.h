...
#define SET_DQ() 		GPIO_SetBits(GPIOA,GPIO_Pin_12)
#define CLR_DQ() 		GPIO_ResetBits(GPIOA,GPIO_Pin_12)

#define GET_DQ() 		GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12)
#define GET_RQ() 		GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_15)


#define SET_CLK()		GPIO_SetBits(GPIOA,GPIO_Pin_13)
#define CLR_CLK()		GPIO_ResetBits(GPIOA,GPIO_Pin_13)
